...
Unzip it, run `OptiMaster.exe`, and make sure FFmpeg is installed on your system `PATH`.
...
The intended release build uses PyInstaller with the bundled OptiMaster icon and the GUI entrypoint:
