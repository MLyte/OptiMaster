...
```powershell
Expand-Archive .\OptiMaster-v2026.4.24-beta.2-windows-x64.zip -DestinationPath .\OptiMaster-release -Force
...
To publish a beta build, commit the source changes first, then push a new tag. Example for `v2026.4.24-beta.2`:
...
git commit -m "Fix executable assets and clarify runtime version"
git push origin main
git tag v2026.4.24-beta.2
git push origin v2026.4.24-beta.2
```
